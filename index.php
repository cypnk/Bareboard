...
<form action="{action}" method="post" class="{form_classes}" id="post_form">
	...
	<p>
		...
		{anonpost_title_input_before}<input id="postname" type="text" class="{input_classes}" aria-describedby="postname-desc" name="title" maxlength="{title_max}" pattern="([^\s][\w\s]{3,100})">{anonpost_title_input_after}
...
<form action="{action}" method="post" class="{form_classes}" id="edit_form">
	...
	<p>
		...
		<input id="postname" type="text" aria-describedby="postname-desc" name="title" maxlength="{title_max}" pattern="([^\s][\w\s]{{title_min},{title_max}})" value="{title}">
...
$templates['tpl_anoncomment_form'] = <<<HTML
<form action="{action}" method="post" class="{form_classes}" id="anon_post_form">
	...
	<p>
		{anoncomment_name_label_before}<label for="postname" class="{label_classes}">{lang:forms:anonpost:name}</label>{anoncomment_name_label_after}
...
$templates['tpl_usercomment_form'] = <<<HTML
...
// Reply edit form
$templates['tpl_editcomment_form'] = <<<HTML
 ...
 */
function verifyAuthLevel( int $level ) {
	$user	= authUser();
...
function forumUser() {
	...
	return $an ? 
	authUser() : verifyAuthLevel( \USER_STATUS_APPROVED );
}
...
function showNewTopicRoute( string $event, array $hook, array $params ) {
	...
	send( 200, 'New topic form in forum ' . $id );
}
